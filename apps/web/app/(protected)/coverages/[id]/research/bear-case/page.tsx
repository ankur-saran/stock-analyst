...
export default function BearCaseResearchPage() {
  const params = useParams<{ id: string }>()
  const coverageId = params.id
  const [taskId, setTaskId] = useState<string | null>(null)
  const runTask = useRunAgentTask(coverageId, "munger_invert")

  return (
    <div className="space-y-4">
      <h2 className="text-xl font-semibold text-slate-900">Bear Case</h2>
      <AgentRunPanel
